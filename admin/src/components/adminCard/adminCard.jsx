...
function AdminCard(props) {
    ...
    function isSaveAvailable() {
        return initialUser.login !== user.login || initialUser.email !== user.email || initialUser.password !== user.password;
    }
    ...
    return (
        <section className="block-card">
            <div className="card-header">
                ...
                >
                    <g id="Back">
                        <path d="M0 0H28C32.4183 0 36 3.58172 36 8V28C36 32.4183 32.4183 36 28 36H0V0Z" fill="#6A8EE8" id="fill"/>
                        <path id="Arrow 2"
                ...
                <span className="card-header-name">Admin ID: {user.id} {user.blocked ? '(заблокирован)' : ''}</span>
            </div>
                ...
                <div className="card-form">
                    <div className="card-form-column-1">
                        ...
                        <TextField
                            ...
                            value={user.password}
                            setValue={(newPassword) => setUser({...user, password: newPassword})}
                        />
                    </div>
